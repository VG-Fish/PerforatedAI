...
def main(args):
    ...
    # NEURON EDIT: prefer XLA when available unless explicitly disabled.
    ...
    # ORDER MATTERS ON XLA: move model before perforate_model so PAI decorates
    # the final parameter objects on-device.
    model.to(device)
