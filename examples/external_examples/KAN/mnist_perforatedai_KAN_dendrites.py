...
def setupKANonfiguration():
    ...
    # This line tells the system to convert the new KANLinears to be dendrite modules
    GPA.pc.append_modules_to_perforate([efficient_kan.KANLinear, nn.Conv2d])
...
def main():
    ...
    model.fc1.set_this_output_dimensions([-1, 0])
    model.fc2.set_this_output_dimensions([-1, 0])
    print('KAN Model:')
    print(model)
